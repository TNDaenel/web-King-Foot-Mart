...
import { BarChartOutlined, DesktopOutlined, ShoppingOutlined } from '@ant-design/icons'
import { MenuProps } from 'antd'
import { AiOutlineControl, AiOutlineFontSize } from 'react-icons/ai'
import { BiSolidCategoryAlt } from 'react-icons/bi'
import { FaClipboardList, FaUserFriends, FaWarehouse } from 'react-icons/fa'
...
export const Menuitems: MenuItem[] = [
  ...
  // quản lý đơn hàng
  getItem(<NavLink to={`/${pathRouter.admin}/feedbacks`}>Phản hồi </NavLink>, 'feedbacks', <FaClipboardList />),
  ...
  getItem('Quản lý', 'manager', <AiOutlineControl />, [
    ...
    getItem(<Link to={`/${pathRouter.admin}/${pathRouter.warehose}`}>Nhà cung cấp</Link>, 'warehose', <FaWarehouse />),
