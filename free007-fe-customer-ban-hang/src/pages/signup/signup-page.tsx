    ...
    <div className='flex items-center justify-start w-full h-screen'>
      <div className='hidden w-1/2 h-full text-white lgl:inline-flex'>
        <div className='w-[450px] h-full bg-primeColor px-10 flex flex-col gap-6 justify-center'>
          <Link to='/'>
            <img src={logo2} alt='logoImg' className='w-[250px] object-cover' />
          </Link>
          ...
          <div className='w-[300px] flex items-start gap-3'>
            ...
            <p className='text-base text-gray-300'>
              <span className='font-semibold text-white font-titleFont'>Get started fast with KingFood Mart</span>
              <br />
          ...
          <div className='w-[300px] flex items-start gap-3'>
            ...
            <p className='text-base text-gray-300'>
              <span className='font-semibold text-white font-titleFont'>Access all KingFood Mart services</span>
              <br />
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab omnis nisi dolor recusandae consectetur!
            </p>
          </div>
